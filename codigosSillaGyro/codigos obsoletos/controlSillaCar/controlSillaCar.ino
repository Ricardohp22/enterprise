...
{  
  if(bluetooth)
  {
    yy_ = datoBT.substring(0,datoBT.indexOf("/")).toInt()+512;
    xx_ = datoBT.substring(datoBT.indexOf("/")+1,datoBT.length()).toInt()+512;
    pp_= 1000;
