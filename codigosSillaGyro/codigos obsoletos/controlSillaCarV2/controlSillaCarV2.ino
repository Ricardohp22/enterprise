...
{  
  if(bluetooth)
  {
    yy_ = datoBT.substring(0,datoBT.indexOf("/")).toInt()*2;
    xx_ = datoBT.substring(datoBT.indexOf("/")+1,datoBT.length()).toInt()*2;
    pp_= 1000;

    yy_=yy_+512;//6 offset
    xx_=xx_+512-46;//26 offset
...
//  Serial.println(nuevoPwmD);
  ...
  if(valAntIzq >127){
    digitalWrite(MotIzqA,HIGH);
    digitalWrite(MotIzqB,LOW);
    nuevoPwmI = map(valAntIzq,127,150,50,255);
  }else if(valAntIzq < 127){
    digitalWrite(MotIzqA,LOW);
    digitalWrite(MotIzqB,HIGH);
    nuevoPwmI = map(valAntIzq,127,50,50,255);
    ...
    digitalWrite(MotDerA,LOW);
    digitalWrite(MotDerB,HIGH);
    nuevoPwmD = map(valAntDer,127,150,50,255);
  }else if(valAntDer < 127){
    digitalWrite(MotDerA,HIGH);
    digitalWrite(MotDerB,LOW);
    nuevoPwmD = map(valAntDer,127,50,50,255);
